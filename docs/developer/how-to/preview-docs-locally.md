...
`src/` is in the watch list because mkdocstrings reads docstrings directly — changing a Google-format docstring in `src/cvo260917/` regenerates the API reference page on the fly.
